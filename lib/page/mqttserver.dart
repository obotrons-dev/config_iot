...
class _MQTTServerState extends State<MQTTServer> {
  ...
  Future mqtt() async{
    if(host.text.length > 0 && port.text.length > 0 && sub.text.length > 0 && user.text.length > 0 && passwords.text.length > 0){
      setState((){
        processing = true;
      });
      var data = {"type":"mqtt",
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text("MQTT Setting",style: TextStyle(color: font)),
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  child: Text(
                    "MQTT Server Setting",style: TextStyle(fontSize: 20,color: font),
                  ),
                ),
              ],
            ),
                        ...
                        child :Container(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              labelText: 'Host',
                              labelStyle: TextStyle(fontSize: 20.0, color: Colors.black26),
                            ),
                          ),
                        ),
                      ),

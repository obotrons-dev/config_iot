...
ElevatedButton.styleFrom(primary: button,textStyle: const TextStyle(fontSize: 15));
    ...
    return ListView.builder(
        itemCount: newlist.length,
          ...
          itemBuilder: (context, int i) {
            ...
            if (_isConnected)
              isConnctedWifi = isRegisteredWifiNetwork(network);
            if (newstr != null){
                  return Card(
                    color:font,
                    child: ListTile(
                        ...
                        trailing: !isConnctedWifi
                            ? OutlineButton(
                          onPressed: () {
                            Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => Attack(network)));
                          },
                          child: Text('connect'),
                        )
                            : SizedBox(
